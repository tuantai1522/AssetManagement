        ...
        public static void SeedAssets(ModelBuilder modelBuilder)
        {
            ...
            List<Asset> assets = new List<Asset>()
            {
                new Asset
                {
                    ...
                    State = AsssetStatus.Available.ToString(),
                ...
                new Asset
                {
                    ...
                    State = AsssetStatus.NotAvailable.ToString(),
                    CreatedAt = DateTime.Now,
                    LastUpdated = DateTime.Now,
                    Location = "HN"
                },
                ...
                new Asset
                {
                    ...
                    State = AsssetStatus.WaitingForRecycling.ToString(),
                    CreatedAt = DateTime.Now,
                    LastUpdated = DateTime.Now,
                    Location = "HCM"
                },
                ...
                new Asset
                {
                    ...
                    State = AsssetStatus.Recycled.ToString(),
                    CreatedAt = DateTime.Now,
                    LastUpdated = DateTime.Now,
                    Location = "HN"
                },
