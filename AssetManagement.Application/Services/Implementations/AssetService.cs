...
namespace AssetManagement.Application.Services.Implementations
{
	public class AssetService : IAssetService
	{
		...
		public AssetService(ILogger<AssetService> logger, IUnitOfWork unitOfWork, ICurrentUser currentUser, UserManager<AppUser> userManager)
		{
			_logger = logger;
		...
		private Expression<Func<Asset, bool>> GetFilterSpecification(FilterAssetRequest filter, AppUser currentUser)
		{
			...
			{
				filterSpecification = filterSpecification.And(a => filter.States.Contains(a.State));
			}
